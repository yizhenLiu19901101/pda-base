...
//            	PageParameter page = new PageParameter();
    ...
    private void setPageParameter(String sql, Connection connection, MappedStatement mappedStatement, BoundSql boundSql, Page page) {
        ...
        try {
            ...
            int totalPage = totalCount / page.getOffset() + ((totalCount % page.getOffset() == 0) ? 0 : 1);
    ...
    public StringBuilder buildPageSqlForMysql(String sql, Page page) {
        ...
        String beginRow = String.valueOf((page.getCurrent() - 1) * page.getOffset());
        pageSql.append(sql);
        pageSql.append(" limit " + beginRow + "," + page.getOffset());
        return pageSql;
    }
    ...
    public StringBuilder buildPageSqlForOracle(String sql, Page page) {
        StringBuilder pageSql = new StringBuilder(100);
        String beginRow = String.valueOf((page.getCurrent() - 1) * page.getOffset());
        String endRow = String.valueOf(page.getCurrent() * page.getOffset());
